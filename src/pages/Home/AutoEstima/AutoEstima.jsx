    ...
    <>
      <Container>
        <Grid1>
          ...
          <h2>Recupere Sua Autoestima</h2>
          <p>Você com autoestima elevada e tendo liberdade de escolha</p>
        </Grid1>
        <Grid2>
          <Buttom>Saiba mais pelo nosso atendimento personalizado</Buttom>
        </Grid2>
      </Container>
    </>
  );
